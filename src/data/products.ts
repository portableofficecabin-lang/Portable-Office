...
export const products: Product[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Fabrication waste stays in the factory, not on your site",
  ...
  },
  {
    ...
    specifications: [
      ...
      { label: "Condition Options", value: "New and certified used 20 ft units — this listing is priced above" },
  ...
  },
  {
    ...
    specifications: [
      ...
      { label: "Configuration", value: "15ft x 10ft (this listing); other sizes on quotation" },
    ],
    features: [
  ...
  },
  {
    ...
    features: [
      "Bolted modular assembly, dismantled and re-erected on relocation",
      "On-site installation of a G+1 colony for 100–300 workers takes 3–6 weeks, after manufacturing",
  ...
  {
    id: "23",
    // Was POC-PC-PREFAB, which collided with id 13. A duplicate SKU becomes a duplicate
    // <g:id> in the Merchant feed (automatic rejection) and a duplicate sku/mpn across two
    // product URLs in JSON-LD. Keep in step with src/data/productCommerce.ts.
    sku: "POC-PC-PPCB",
    ...
    features: [
      ...
      "On-site installation takes hours to 2 days once the unit is delivered",
      "Relocatable 5–10 times over lifespan with bolted joint assembly",
      "PUF insulation keeps the interior cooler and reduces the load on air conditioning",
      "Recyclable materials with minimal on-site construction debris",
  ...
  },
  {
    ...
    specifications: [
      ...
      { label: "Reusability", value: "3–10 project cycles, dismantled and re-erected each time" },
    ],
    features: [
  ...
  },
  {
    ...
    category: "Portable Cabins",
    categorySlug: "portable-cabins",
    description: "Complete cabin portable solutions including site offices, worker accommodation, security cabins, portable toilets, and container conversions. MS, GI, FRP, and sandwich panel construction. Factory-built and delivered across India.",
    ...
    specifications: [
      ...
      { label: "Construction", value: "Bolted modular assembly, dismantled and re-erected on relocation" },
  ...
  },
  {
    ...
    features: [
      ...
      "Reusable for 8–10 project cycles rather than rebuilt each time",
  ...
  },
  {
    ...
    features: [
      ...
      "Containers reused rather than scrapped, with minimal on-site debris",
    ],
    images: [],
    price: 50000,
  ...
  },
  {
    id: "30",
    sku: "POC-SC-KRSH",
    name: "Refurbished 20 ft Shipping Container (Premium)",
  ...
  },
  {
    id: "31",
    sku: "POC-SC-SIPCOT",
    name: "Refurbished 20 ft Shipping Container (Industrial)",
  ...
  },
  {
    id: "33",
    sku: "POC-SC-NRSP",
    name: "Refurbished 20 ft Shipping Container",
  ...
  },
  {
    id: "34",
    sku: "POC-SC-PNYA",
    name: "Used 20 ft Shipping Container (Cargo-Worthy)",
  ...
  },
  {
    ...
    specifications: [
      { label: "Sizes Available", value: "20ft x 8ft (this listing); 10ft / 40ft on quotation" },
