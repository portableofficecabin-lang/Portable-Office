...
export const STEP_OF_KIND: Record<ColonyPartKind, ColonyAssemblyStep> = {
  ...
  "joist-web": 8,
  /* The MS pipe frame is bolted over the rafters BEFORE any deck sheet — same step, later phase. */
  "floor-tube": 8,
...
export const LAYER_OF_KIND: Record<ColonyPartKind, ColonyPartLayer> = {
  ...
  "floor-beam": "structure", joist: "structure", "joist-web": "structure", "floor-tube": "structure", brace: "structure", noggin: "structure",
...
export const COLOR_OF_KIND: Record<ColonyPartKind, string> = {
  ...
  "floor-beam": "#3b4a5e", joist: "#94a3b8", "joist-web": "#7e94ab", "floor-tube": "#1380a1", brace: "#0ea5e9", noggin: "#a3b3c6",
...
export const ENG_ONLY = new Set<ColonyPartKind>([
  ...
  "column", "stud", "rail", "base-beam", "floor-beam", "joist", "joist-web", "floor-tube", "brace", "noggin",
