...
const faqs = [
  ...
  { q: "What insulation options are available for Indian climate conditions?", a: "We offer PUF, EPS, glass wool and rock wool in 40–60 mm thickness. Which one suits you depends on the site — sustained heat and coastal humidity are handled differently from a temperate inland location — so tell us where the container is going and we will specify the panel and quote it before fabrication starts." },
  ...
  { q: "What is the expected lifespan of a steel portable office container?", a: "It depends on the site and the upkeep, so we do not publish a single figure. What we can tell you is what the maintenance actually is: repaint every few years, inspect the sealant annually, and keep the roof drains clear. Units maintained that way are relocated across multiple project cycles rather than replaced." },
  { q: "How do steel portable offices compare to traditional brick-and-mortar site offices?", a: "Total project time drops from 60–90 days to 14–21 days, translating to faster mobilization and earlier revenue generation. The unit is relocatable rather than written off at the end of the project, and fabrication happens in the works rather than on your site. The container listed on this page is sold at the single price shown above, inclusive of 18% GST." },
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              ...
              <li><strong className="text-foreground">Upkeep:</strong> repaint every few years, annual sealant inspection, keep roof drains clear</li>
