          ...
          <div className="max-w-3xl">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <h1 className="font-display text-4xl sm:text-5xl font-bold">
                {/* Per-category SEO H1 override (one H1 per page — this replaces, never adds). */}
                {activeCategoryObj ? (CATEGORY_H1[activeCategoryObj.slug] ?? activeCategoryObj.name) : "Our Products"}
              </h1>
            </div>
