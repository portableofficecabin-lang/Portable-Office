...
export default function CartPage() {
  ...
  if (!user) {
    return (
      <Layout>
        <SEOHead title="Cart | Portable Office Cabin" description="View your shopping cart." />
  ...
  return (
    <Layout>
      <SEOHead title="Cart | Portable Office Cabin" description="View and manage items in your shopping cart." />
      <section className="section-padding">
          ...
          {items.length === 0 ? (
            ...
            <div className="space-y-4">
              ...
              <div className="bg-card rounded-xl border border-border/50 p-6 mt-6">
                ...
                <p className="text-xs text-muted-foreground mb-4">* GST, transportation & installation charges extra</p>
