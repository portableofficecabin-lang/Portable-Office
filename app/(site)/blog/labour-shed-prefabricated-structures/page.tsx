...
export const metadata = buildPageMetadata({
  ...
  description:
    "Prefabricated labour sheds for construction sites in India. 40–60% faster deployment, 8–15 year lifespan, modular design for 50–1000+ workers. Call us today!",
  keywords:
